  ...
  <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 animate-pulse">
    ...
    <div className="lg:grid lg:grid-cols-2 lg:gap-12 bg-white p-4 sm:p-8 rounded-xl shadow-lg border border-stone-200">
      <div className="space-y-4">
        <div className="bg-stone-200 rounded-xl aspect-[2/3]"></div>
        <div className="flex space-x-3 p-1">
          <div className="w-16 h-24 bg-stone-200 rounded-lg"></div>
          <div className="w-16 h-24 bg-stone-200 rounded-lg"></div>
          <div className="w-16 h-24 bg-stone-200 rounded-lg"></div>
        </div>
      </div>
...
const ProductDetailsPage: React.FC = () => {
  ...
  return (
    <main className="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-16 sm:pb-12 sm:pt-8 bg-white sm:bg-transparent min-h-screen sm:min-h-fit">
      ...
      {/* Changed: Removed px-4 on mobile to enable Edge-to-Edge look */}
      <div className="lg:grid lg:grid-cols-2 lg:gap-12 bg-white sm:p-8 sm:rounded-xl sm:shadow-lg sm:border sm:border-stone-200">
        ...
        <div className="space-y-4">
          <div 
            ...
            // Changed: Aspect Ratio 2/3 for Slimmer/Taller look ("Chikom")
          ...
          {/* Thumbnails Container - Added px-4 for mobile spacing */}
          {images.length > 0 && (
                  ...
                  <div className="mt-4 border border-stone-200 rounded-xl p-2 sm:p-3 bg-stone-50/50">
                      <div className="flex gap-3 overflow-x-auto scrollbar-hide">
                        {images.map((img, index) => (
                          <div 
                            key={index}
                            className={`relative w-16 sm:w-20 aspect-[2/3] flex-shrink-0 rounded-lg cursor-pointer transition-all duration-200 border-2 overflow-hidden ${index === currentImageIndex ? 'border-pink-600 ring-1 ring-pink-600 opacity-100' : 'border-stone-200 hover:border-pink-300 opacity-70 hover:opacity-100'}`}
        ...
        {/* Right Column: Details - Added px-4 for mobile spacing */}
